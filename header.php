                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="header-top-left">
                                    <ul>
                                        ...
                                        <li><i class="fa fa-envelope" aria-hidden="true"></i><a href="#">info@physics.com</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="col-lg-10 col-md-10 col-sm-10">
                                <nav id="desktop-nav">
                                    <ul>
                                       ...
                                       <li><a >People</a>
                                            <ul>
                                                <li><a href="demo.php">Faculty</a></li>
                                        ...
                                        <li class="has-child-menu"><a >Students</a>
                                            <ul>
                                                <li><a href="btech.php?yr=<?php echo date('Y'); ?>&deg=1dsds">Engineering Physics</a></li>
                                                <li><a href="#">Dual Degree Program BS & MS</a></li>
                                                <li><a href="#">M.Tech</a></li>
                                                <li><a href="#">M.Sc.</a></li>
                                                <li><a href="#">Ph.D</a></li>
                                                <li><a href="#">Interdisciplinary Dual Degree Programs</a></li>
                                                
                                            </ul>
                                        </li>
                                        <li><a href="research-area.php">Research</a></li>
                                        ...
                                        <li><a >Events</a>
                                            <ul>
                                                ...
                                                <li><a href="#">Journal clubs</a></li>
                                                <li><a href="#">In-house Symposium</a></li>
                                       ...
                                       <li><a href="committee.php">committees</a> 
                                ...
                                <nav id="dropdown">
                                      <ul>
                                       ...
                                       <li><a href="#">People</a>
                                        ...
                                        <li><a href="#">Program</a>
                                            <ul>
                                                <li><a href="courses1.html">B. Tech</a></li>
                                                <li><a href="courses2.html">M. Tech</a></li>
                                                <li><a href="courses3.html">PhD </a></li>
                                        ...
                                        <li><a href="research2.html">Research</a>
                                            <!--<ul>
                                        ...
                                        <li><a href="gallery2.html">Gallery</a>
                                            <!--<ul>
