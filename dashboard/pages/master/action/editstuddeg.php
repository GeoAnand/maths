...
if($UsQuery){
	header('location:'.$home_path.'/pages/master/editstuddeg.php?msg=success&id='.$_POST['idD']);
}else{
	header('location:'.$home_path.'/pages/master/editstuddeg.php?msg=error&id='.$_POST['idD']);	
}
