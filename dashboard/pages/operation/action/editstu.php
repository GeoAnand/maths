...
$sqqu=mysqli_query($conn,"select * from student where id='".$_POST['idD']."'");
$rqqu=mysqli_fetch_array($sqqu);



	$sqlBl="UPDATE student SET ";
	$sqlBl=$sqlBl."pid='".$sts."',";
...
if($UsQuery){
	header('location:'.$home_path.'/pages/operation/editstudent.php?msg=success&id='.$_POST['idD']);
}else{
	header('location:'.$home_path.'/pages/operation/editstudent.php?msg=error&id='.$_POST['idD']);	
}
