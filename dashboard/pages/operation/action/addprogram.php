...
$rd=mysqli_fetch_array(mysqli_query($conn,"select MAX(fid)AS fd from programnew"));
$fd=$rd['fd']+1;
...
if($_POST['cname'][$cc]!=''){
$sq=mysqli_query($conn,"select * from programnew where id='".$_POST['intid'][$cc]."'");
...
$sql="insert into programnew(fuid,fid,deg,sem,cno,cname,credit,status,added_by,added_on)";
$sql.=" values(";
...
$sqqu=mysqli_query($conn,"select * from programnew where fid='".$_POST['fid']."' AND fuid='".$_POST['fuid']."'");
$rqqu=mysqli_fetch_array($sqqu);

$sqlBl="UPDATE programnew SET "; 
...
$sq1=mysqli_query($conn,"select * from programnewwin where id='".$_POST['intid1'][$cc]."'");
...
$sql="insert into programnewwin(fuid,fid,deg,sem,win,wcno,wcname,wcredit,status,added_by,added_on)";
$sql.=" values(";
$sql.="'".mysqli_real_escape_string($conn,$_POST['fuid'])."',";
$sql.="'".mysqli_real_escape_string($conn,$fd)."',";
$sql.="'".mysqli_real_escape_string($conn,$_POST['deg'])."',";
...
$sqqu1=mysqli_query($conn,"select * from programnewwin where fid='".$_POST['fid']."' AND fuid='".$_POST['fuid']."'");
$rqqu1=mysqli_fetch_array($sqqu1);

$sqlBl="UPDATE programnewwin SET "; 
$sqlBl=$sqlBl."fuid='".mysqli_real_escape_string($conn,$_POST['fuid'])."',";
$sqlBl=$sqlBl."fid='".mysqli_real_escape_string($conn,$_POST['fid'])."',";
$sqlBl=$sqlBl."deg='".mysqli_real_escape_string($conn,$_POST['deg'])."',";
$sqlBl=$sqlBl."sem='".mysqli_real_escape_string($conn,$_POST['sem'])."',";
...
$sq12=mysqli_query($conn,"select * from programnewsmr where id='".$_POST['intid2'][$cc]."'");
if(mysqli_num_rows($sq1)==0){
...
$sql="insert into programnewsmr(fuid,fid,deg,sem,smr,scno,scname,scredit,status,added_by,added_on)";
$sql.=" values(";
$sql.="'".mysqli_real_escape_string($conn,$_POST['fuid'])."',";
$sql.="'".mysqli_real_escape_string($conn,$fd)."',";
$sql.="'".mysqli_real_escape_string($conn,$_POST['deg'])."',";
...
$sqqu12=mysqli_query($conn,"select * from programnewsmr where fid='".$_POST['fid']."' AND fuid='".$_POST['fuid']."'");
$rqqu12=mysqli_fetch_array($sqqu12);

$sqlBl="UPDATE programnewsmr SET "; 
$sqlBl=$sqlBl."fuid='".mysqli_real_escape_string($conn,$_POST['fuid'])."',";
$sqlBl=$sqlBl."fid='".mysqli_real_escape_string($conn,$_POST['fid'])."',";
$sqlBl=$sqlBl."deg='".mysqli_real_escape_string($conn,$_POST['deg'])."',";
$sqlBl=$sqlBl."sem='".mysqli_real_escape_string($conn,$_POST['sem'])."',";
...
if($UsQuery){
	header('location:'.$home_path.'/pages/operation/viewprogram.php?msg=success&deg='.$_POST['deg'].'&sem='.$_POST['sem']);
}else{
	header('location:'.$home_path.'/pages/operation/viewprogram.php?msg=error&deg='.$_POST['deg'].'&sem='.$_POST['sem']);
}
