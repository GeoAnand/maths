...
$sql="insert into iddd(pid,deg,yr,sname,rollno,status,added_by,added_on)";
	$sql.=" values(";
	$sql.="'".$pid."',";
	$sql.="'".$_POST['deg']."',";
	$sql.="'".$_POST['yr']."',";
...
if($UsQuery){
	header('location:'.$home_path.'/pages/operation/addiddd.php?msg=success&rcpt=');
}else{
	header('location:'.$home_path.'/pages/operation/addiddd.php?msg=error');	
}
