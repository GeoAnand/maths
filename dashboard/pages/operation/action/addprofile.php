...
/* $rd3=mysqli_fetch_array(mysqli_query($conn,"select * from profile where facid='".$_POST['fusrid']."'")); */
...
$rd12=mysqli_fetch_array(mysqli_query($conn,"select * from faculty where id='".$_POST['fuid']."'"));
$fdivision=$rd12['fdivision'];

//$sq=mysqli_query($conn,"select * from profile where fuid='".$_POST['fuid']."' AND fusrid='".$_POST['fusrid']."'");
...
$sql="insert into profile(fuid,fid,fusrid,fdivision,fusrname,fusremail,fname1,fname,fdesig,femail,femail1,fmobile,fcvpht,fcvatt,fweblink,freslink,researchbook,faddr,fedu,wla,rai,visit,status,added_by,added_on)";
$sql.=" values(";
...
$sql.="'".mysqli_real_escape_string($conn,$fdivision)."',";

$sql.="'".mysqli_real_escape_string($conn,$rd1['name'])."',";
$sql.="'".mysqli_real_escape_string($conn,$rd1['username'])."',";
$sql.="'".mysqli_real_escape_string($conn,$_POST['fname1'])."',";
$sql.="'".mysqli_real_escape_string($conn,$_POST['fname'])."',";

$sql.="'".mysqli_real_escape_string($conn,$_POST['fdesig'])."',";
...
$sql.="'".mysqli_real_escape_string($conn,$_POST['freslink'])."',";

$sql.="'1',";

$sql.="'".mysqli_real_escape_string($conn,$_POST['faddr'])."',";
$sql.="'".mysqli_real_escape_string($conn,$_POST['fedu'])."',";
$sql.="'".mysqli_real_escape_string($conn,$_POST['wla'])."',";
$sql.="'".mysqli_real_escape_string($conn,$_POST['rai'])."',";
$sql.="'".mysqli_real_escape_string($conn,$_POST['visit'])."',";
...
$sqlBl=$sqlBl."fdivision='".$fdivision."',";
$sqlBl=$sqlBl."fname1='".mysqli_real_escape_string($conn,$_POST['fname1'])."',";
$sqlBl=$sqlBl."fname='".mysqli_real_escape_string($conn,$_POST['fname'])."',";

$sqlBl=$sqlBl."fdesig='".mysqli_real_escape_string($conn,$_POST['fdesig'])."',";
...
$sqlBl=$sqlBl."freslink='".mysqli_real_escape_string($conn,$_POST['freslink'])."',";

$sqlBl=$sqlBl."researchbook='1',";
$sqlBl=$sqlBl."faddr='".mysqli_real_escape_string($conn,$_POST['faddr'])."',";
$sqlBl=$sqlBl."fedu='".mysqli_real_escape_string($conn,$_POST['fedu'])."',";


$sqlBl=$sqlBl."wla='".mysqli_real_escape_string($conn,$_POST['wla'])."',";
$sqlBl=$sqlBl."rai='".mysqli_real_escape_string($conn,$_POST['rai'])."',";

$sqlBl=$sqlBl."visit='".mysqli_real_escape_string($conn,$_POST['visit'])."',";
