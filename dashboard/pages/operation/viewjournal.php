...
<a href="<?php echo $home_path; ?>/pages/operation/addjournal.php"><button class="btn btn-primary" type="button">Add New Publication</button></a>
</div>
...
<?php
$sql="select * from profilejournal where fuid='".$_GET['facid']."' order by id DESC";
//echo $sql;
...
<tr>
<td hidden>
    <input type="text" id="idd" name="idd[]" value="<?php if(isset($rw['id']) && $rw['id']!=''){ echo $rw['id'];}else{echo "";} ?>" style="display:none;"></td>    
<td>
    <input type="text" id="intid" name="intid[]" value="<?php if(isset($rw['id']) && $rw['id']!=''){ echo $rw['id'];}else{echo "";} ?>" style="display:none;">
<textarea  id="jauthor<?php echo $x ; ?>" name="jauthor[]" class="form-control" style="height:125px;width:100%;"><?php if(isset($rw['jauthor'])) { echo $rw['jauthor'] ;} ?></textarea></td>
<td><textarea  id="jdesc<?php echo $x ; ?>" name="jdesc[]" class="form-control" style="height:125px;width:100%;"><?php if(isset($rw['jauthor'])) { echo $rw['jdesc'] ;} ?></textarea></td>
<td><textarea  id="jcitedesc<?php echo $x ; ?>" name="jcitedesc[]" class="form-control" style="height:125px;width:100%;"><?php if(isset($rw['jauthor'])) { echo $rw['jcitedesc'] ;} ?></textarea></td>

<td><textarea  id="volume<?php echo $x ; ?>" name="volume[]" class="form-control" style="height:125px;width:100%;"><?php if(isset($rw['jauthor'])) { echo $rw['volume'] ;} ?></textarea></td>

<td><textarea  id="page<?php echo $x ; ?>" name="page[]" class="form-control" style="height:125px;width:100%;"><?php if(isset($rw['jauthor'])) { echo $rw['page'] ;} ?></textarea></td>

<td><textarea  id="doi<?php echo $x ; ?>" name="doi[]" class="form-control" style="height:125px;width:100%;"><?php if(isset($rw['jauthor'])) { echo $rw['doi'] ;} ?></textarea></td>

<td><textarea  id="doilnk<?php echo $x ; ?>" name="doilnk[]" class="form-control" style="height:125px;width:100%;"><?php if(isset($rw['jauthor'])) { echo $rw['doilnk'] ;} ?></textarea></td>

<td><textarea  id="ar<?php echo $x ; ?>" name="ar[]" class="form-control" style="height:125px;width:100%;"><?php if(isset($rw['jauthor'])) { echo $rw['ar'] ;} ?></textarea></td>

<td><textarea  id="arlnk<?php echo $x ; ?>" name="arlnk[]" class="form-control" style="height:125px;width:100%;"><?php if(isset($rw['jauthor'])) { echo $rw['arlnk'] ;} ?></textarea></td>

<td><textarea  id="lnk<?php echo $x ; ?>" name="lnk[]" class="form-control" style="height:125px;width:100%;"><?php if(isset($rw['jauthor'])) { echo $rw['lnk'] ;} ?></textarea></td>

<td><textarea  id="year<?php echo $x ; ?>" name="year[]" class="form-control" style="height:125px;width:100%;"><?php if(isset($rw['jauthor'])) { echo $rw['year'] ;} ?></textarea></td>



<td class='chng' style='width:45px;text-align:center;'>  <a href="<?php echo $home_path; ?>/pages/operation/action/seljournalDelete.php?id=<?php echo $rw['id']; ?>&facid=<?php echo $_GET['facid']; ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a></td>
</tr>
<?php }  ?>                 
</tbody>
...
function selCHg(){
	...
	document.location.href="<?php echo $home_path; ?>/pages/operation/viewjournal.php?fid=&facid="+facname;
}
