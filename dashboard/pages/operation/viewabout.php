...
<form id="from1" name="from1" enctype="multipart/form-data"  action="<?php echo $home_path;?>/pages/operation/action/addabout.php" method="post" class="form-horizontal form-label-left" style="" autocomplete="off">      
...
<td><textarea id="des<?php echo $x ; ?>" name="des[]" class="form-control" style="width:100%;"  onkeypress="return pointNum(event)"><?php echo $rw['des'] ; ?></textarea></td>

<td class='chng' style='width:45px;text-align:center;'>  <a href="<?php echo $home_path; ?>/pages/operation/action/selintaboutDelete.php?id=<?php echo $rw['id']; ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a></td>
</tr>
 ...
 function(isConfirm){
   if (isConfirm){
	 ...
	 id=a;
		$.ajax({
	type:'GET',
	url:'<?php echo $home_path; ?>/pages/operation/action/selintaboutDelete.php',
		data:{
		id:id
		},
		success:function(data){
