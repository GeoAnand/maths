...
<form id="from1" name="from1" enctype="multipart/form-data"  action="<?php echo $home_path;?>/pages/operation/action/addidddprogramdes.php" method="post" class="form-horizontal form-label-left" style="" autocomplete="off">      
...
<option value="">-- Select IDDD Category Name --</option>
...
<div class="row">
    ...
    <?php
$sql3="select * from programidddnewdes where  deg='".$_GET['deg']."'   order by id ASC";
...
?>	
    <input type="text" id="intid" name="intid" value="<?php echo $rw3['id']; ?>" style="display:none;">
     ...
     <div class="col-md-3" style="margin: 5px 0 25px 0;">
<div class="form-group">
<label class="control-label col-md-4 col-sm-4 col-xs-12" for="first-name">Description
</label>
<div class="col-md-8 col-sm-8 col-xs-12">
  <textarea id="des" name="des"  class="form-control col-md-7 col-xs-12"><?php if(isset($rw3['des'])){ echo nl2br($rw3['des']); }else{ echo ""; } ?></textarea>
     ...
     <div class="col-md-3" style="margin: 5px 0 25px 0;">
<div class="form-group">
<label class="control-label col-md-4 col-sm-4 col-xs-12" for="first-name"> The Programme 
</label>
<div class="col-md-8 col-sm-8 col-xs-12">
  <textarea id="po" name="po"  class="form-control col-md-7 col-xs-12"><?php if(isset($rw3['po'])){ echo nl2br($rw3['po']); }else{ echo ""; } ?></textarea>
     ...
     <div class="col-md-3" style="margin: 5px 0 25px 0;">
<div class="form-group">
<label class="control-label col-md-4 col-sm-4 col-xs-12" for="first-name">Eligibility
</label>
<div class="col-md-8 col-sm-8 col-xs-12">
 ...
 <div class="col-md-3" style="margin: 5px 0 25px 0;">
<div class="form-group">
<label class="control-label col-md-4 col-sm-4 col-xs-12" for="first-name">Curriculum
</label>
<div class="col-md-8 col-sm-8 col-xs-12">
...
function selSEMChg(){
    	...
    	if(deg==''){
    	    ...
    	    document.location.href="<?php echo $home_path;?>/pages/operation/viewidddprogramdes.php?deg="+deg;
    	}
