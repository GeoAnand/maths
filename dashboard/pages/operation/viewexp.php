...
<form id="from1" name="from1" enctype="multipart/form-data"  action="<?php echo $home_path;?>/pages/operation/action/addexperience.php" method="post" class="form-horizontal form-label-left" style="" autocomplete="off">      
...
<label class="control-label col-md-4 col-sm-4 col-xs-12" for="first-name">Add Course (Add Number of Rows)
</label>
...
<?php
$sql="select * from  profileexperience where fuid='".$_GET['facid']."'";
...
<tr>
<td><input type="text" id="fromto<?php echo $x ; ?>" name="fromto[]" class="form-control" value="<?php echo $rw['fromto'] ; ?>" style="width:100%;"  onkeypress="return pointNum(event)" /></td>
<td><input type="text" id="desig<?php echo $x ; ?>" name="desig[]" class="form-control" value="<?php echo $rw['desig'] ; ?>" style="width:100%;"  onkeypress="return pointNum(event)" /></td>
<td class='chng' style='width:45px;text-align:center;'>  <a href="<?php echo $home_path; ?>/pages/operation/action/selexpDelete.php?id=<?php echo $rw['id']; ?>&facid=<?php echo $_GET['facid']; ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a></td>
</tr>
<?php }  ?>                 
</tbody>
