...
<form id="from1" name="from1" enctype="multipart/form-data"  action="<?php echo $home_path;?>/pages/operation/action/addidddprogram.php" method="post" class="form-horizontal form-label-left" style="" autocomplete="off">      
...
<div class="col-md-8 col-sm-8 col-xs-12">
  <select name="deg" id="deg" class="form-control col-md-7 col-xs-12 select2"  onchange="selCHg1();" required>
<option value="">-- Select Degree Name --</option>
<option value="1"<?php echo ($_GET['deg']=='1')?'selected':''; ?>>Advanced Materials and Nano Technology</option>
<option value="2"<?php echo ($_GET['deg']=='2')?'selected':''; ?>>Complex Systems and Dynamics</option>
<option value="3"<?php echo ($_GET['deg']=='3')?'selected':''; ?>>Quantum Science and Technology (QuST)</option>
</select>
</div>
</div>
</div>
...
<option value="1"<?php echo ($_GET['sem']=='1')?'selected':''; ?>
> 1 Semester </option>
<option value="2"<?php echo ($_GET['sem']=='2')?'selected':''; ?>> 2 Semester </option>
<option value="3"<?php echo ($_GET['sem']=='3')?'selected':''; ?>> 3 Semester </option>
<option value="4"<?php echo ($_GET['sem']=='4')?'selected':''; ?>> 4 Semester </option>
<option value="5"<?php echo ($_GET['sem']=='5')?'selected':''; ?>> 5 Semester </option>
<option value="6"<?php echo ($_GET['sem']=='6')?'selected':''; ?>> 6 Semester </option>
<option value="7"<?php echo ($_GET['sem']=='7')?'selected':''; ?>> 7 Semester </option>
<option value="8"<?php echo ($_GET['sem']=='8')?'selected':''; ?>> 8 Semester </option>
<option value="9"<?php echo ($_GET['sem']=='9')?'selected':''; ?>> 9 Semester </option>
<option value="10"<?php echo ($_GET['sem']=='10')?'selected':''; ?>> 10 Semester </option>
...
<div style="margin:6px 0 0 0;" class="col-md-12 tableFixHead">
 <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
  ...
  <tbody>
<?php
$sql="select * from programidddnew where deg='".$_GET['deg']."' AND sem='".$_GET['sem']."' order by id ASC";
...
<td class='chng' style='width:45px;text-align:center;'>  <a href="<?php echo $home_path; ?>/pages/operation/action/selidsemDelete.php?id=<?php echo $rw['id']; ?>&facid=<?php echo $_GET['facid']; ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a></td>
</tr>
<?php }  ?>                 
</tbody>
...
<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
  ...
  <tbody>
<?php
$sql2="select * from programidddnewwin where  deg='".$_GET['deg']."' AND sem='".$_GET['sem']."' order by id ASC";
...
<td class='chng' style='width:45px;text-align:center;'>  <a href="<?php echo $home_path; ?>/pages/operation/action/selidwinDelete.php?id=<?php echo $rw2['id']; ?>&facid=<?php echo $_GET['facid']; ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a></td>
</tr>
<?php }  ?>                 
</tbody>
...
<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
  ...
  <tbody>
<?php
$sql3="select * from programidddnewsmr where  deg='".$_GET['deg']."' AND sem='".$_GET['sem']."'  order by id ASC";
...
<td class='chng' style='width:45px;text-align:center;'>  <a href="<?php echo $home_path; ?>/pages/operation/action/selidsmrDelete.php?id=<?php echo $rw3['id']; ?>&facid=<?php echo $_GET['facid']; ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a></td>
</tr>
<?php }  ?>                 
</tbody>
...
function selSEMChg(){
    	...
    	if(deg==''){
    	    ...
    	    document.location.href="<?php echo $home_path;?>/pages/operation/viewidddprogram.php?deg="+deg+"&sem="+sem;
    	}
