...
<form id="from1" name="from1" enctype="multipart/form-data"  action="<?php echo $home_path;?>/pages/operation/action/addbook.php" method="post" class="form-horizontal form-label-left" style="" autocomplete="off">      

<?php
$sq2=mysqli_query($conn,"select * from  profilebook where fuid='".$_GET['facid']."'");
...
<?php
$sql="select * from  profilebook where fuid='".$_GET['facid']."'";
...
function selCHg(){
	...
	document.location.href="<?php echo $home_path; ?>/pages/operation/viewbooks.php?fid=&facid="+facname;
}
