...
?>			
<tr>
<td><input type="text" id="awyear<?php echo $x ; ?>" name="awyear[]" class="form-control" value="<?php //echo $rq['awyear'] ; ?>" style="width:500px;"  onkeypress="return pointNum(event)" /></td>
<td><textarea  id="awdesc<?php echo $x ; ?>" name="awdesc[]" class="form-control" style="height:125px;width:100%;"><?php //echo $rq['awdesc'] ; ?></textarea></td>
