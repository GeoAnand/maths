...
if($UsQuery){
	header('location:'.$home_path.'/pages/about/editabout.php?msg=success&id='.$_POST['idD']);
}else{
	header('location:'.$home_path.'/pages/about/editabout.php?msg=error&id='.$_POST['idD']);	
}
