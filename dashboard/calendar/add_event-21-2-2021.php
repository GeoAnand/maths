...
$sql="insert into events(evt_start,evt_end,evt_text,evt_color,title,eventtype,starttime,starthr,startmn,endtime,endhr,	endmn,image,url,description,status,added_by,added_on)";
		$sql.=" values(";
