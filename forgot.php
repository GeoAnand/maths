...
<script>	
swal("Error!", "Your Username or Password is wrong.");
</script>
<?php } ?>       
...
<?php if(isset($_GET['msg']) && $_GET['msg']=='error'){  ?>
<h5 class="sidebar-title" style="font-weight:bold;color:#ad0b0b;">Error!, "Your Username or Password is wrong.</h5>
<?php } ?>  
...
<td><input type="email" id="username" name="username" Placeholder="Enter your User Name" class="form-control" /></td>
</tr>
<tr> 
<td>&nbsp;</td>
