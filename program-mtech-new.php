...
$sqlBj="select * from programnewdes where deg='3' order by id ASC";    
...
$sqlB="select * from programnew where deg='3'  AND sem='1' order by id ASC";    
...
<?php } ?>		          
	...
	<!-- <?php 
	$sqlB2="select * from programnewwin where win='winter' AND deg='3' AND sem='1' order by id ASC";
...
$sqlB="select * from programnewwin where win='winter' AND deg='3' AND sem='1' order by id ASC";    
$sqlBS=mysqli_query($conn,$sqlB);
$x=0;
while($rw=mysqli_fetch_array($sqlBS)){
    $x++
...
<?php } ?>		          
		 ...
		 <?php } ?>            -->
		        	...
		        	<!-- <?php 
	$sqlB3="select * from programnewsmr where win='summer' AND deg='3' AND sem='1' order by id ASC";
...
$sqlB="select * from programnewsmr where win='summer' AND deg='3' AND sem='1' order by id ASC";    
$sqlBS=mysqli_query($conn,$sqlB);
$x=0;
while($rw=mysqli_fetch_array($sqlBS)){
    $x++
...
$sqlB="select * from programnew where deg='3'  AND sem='2' order by id ASC";    
$sqlBS=mysqli_query($conn,$sqlB);
$x=0;
while($rw=mysqli_fetch_array($sqlBS)){
    $x++
...
<?php } ?>		          
	...
	<?php 
	$sqlB2="select * from programnewwin where win='winter' AND deg='3' AND sem='2' order by id ASC";
	$sqlBS2=mysqli_query($conn,$sqlB2);
	$rw2=mysqli_fetch_array($sqlBS2);
	if($rw2['win']=='winter'){	            
...
$sqlB="select * from programnewwin where win='winter' AND deg='3' AND sem='2' order by id ASC";    
$sqlBS=mysqli_query($conn,$sqlB);
$x=0;
while($rw=mysqli_fetch_array($sqlBS)){
    $x++
...
<?php } ?>		          
		 ...
		 <?php } ?>           
		        	...
		        	<?php 
	$sqlB3="select * from programnewsmr where smr='summer' AND deg='3' AND sem='2' order by id ASC";
	$sqlBS3=mysqli_query($conn,$sqlB3);
	$rw3=mysqli_fetch_array($sqlBS3);
	if($rw3['smr']=='summer'){	            
...
$sqlB="select * from programnewsmr where smr='summer' AND deg='3' AND sem='2' order by id ASC";    
$sqlBS=mysqli_query($conn,$sqlB);
$x=0;
while($rw=mysqli_fetch_array($sqlBS)){
    $x++
...
$sqlB="select * from programnew where deg='3'  AND sem='3' order by id ASC";    
$sqlBS=mysqli_query($conn,$sqlB);
$x=0;
while($rw=mysqli_fetch_array($sqlBS)){
    $x++
...
<?php } ?>		          
	...
	<?php 
	$sqlB2="select * from programnewwin where win='winter' AND deg='3' AND sem='3' order by id ASC";
	$sqlBS2=mysqli_query($conn,$sqlB2);
	$rw2=mysqli_fetch_array($sqlBS2);
	if($rw2['win']=='winter'){	            
...
$sqlB="select * from programnewwin where win='winter' AND deg='3' AND sem='3' order by id ASC";    
$sqlBS=mysqli_query($conn,$sqlB);
$x=0;
while($rw=mysqli_fetch_array($sqlBS)){
    $x++
...
<?php } ?>		          
		 ...
		 <?php } ?>           
		        	...
		        	<?php 
	$sqlB3="select * from programnewsmr where smr='summer' AND deg='3' AND sem='3' order by id ASC";
	$sqlBS3=mysqli_query($conn,$sqlB3);
	$rw3=mysqli_fetch_array($sqlBS3);
	if($rw3['smr']=='summer'){	            
...
$sqlB="select * from programnewsmr where smr='summer' AND deg='3' AND sem='3' order by id ASC";    
$sqlBS=mysqli_query($conn,$sqlB);
$x=0;
while($rw=mysqli_fetch_array($sqlBS)){
    $x++
...
$sqlB="select * from programnew where deg='3'  AND sem='4' order by id ASC";    
$sqlBS=mysqli_query($conn,$sqlB);
$x=0;
while($rw=mysqli_fetch_array($sqlBS)){
    $x++
...
<?php } ?>		          
	...
	<?php 
	$sqlB2="select * from programnewwin where win='winter' AND deg='3' AND sem='4' order by id ASC";
	$sqlBS2=mysqli_query($conn,$sqlB2);
	$rw2=mysqli_fetch_array($sqlBS2);
	if($rw2['win']=='winter'){	            
...
$sqlB="select * from programnewwin where win='winter' AND deg='3' AND sem='4' order by id ASC";    
$sqlBS=mysqli_query($conn,$sqlB);
$x=0;
while($rw=mysqli_fetch_array($sqlBS)){
    $x++
...
<?php } ?>		          
		 ...
		 <?php } ?>           
		        	...
		        	<?php 
	$sqlB3="select * from programnewsmr where smr='summer' AND deg='3' AND sem='4' order by id ASC";
	$sqlBS3=mysqli_query($conn,$sqlB3);
	$rw3=mysqli_fetch_array($sqlBS3);
	if($rw3['smr']=='summer'){	            
...
$sqlB="select * from programnewsmr where smr='summer' AND deg='3' AND sem='4' order by id ASC";    
$sqlBS=mysqli_query($conn,$sqlB);
$x=0;
while($rw=mysqli_fetch_array($sqlBS)){
    $x++
...
$sj="select * from programnewdes where deg='3' order by id ASC";    
...
?>     
	   ...
	   <div>
               <h3 style="color:#002147">Career Prospects</h3>
