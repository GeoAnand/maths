	...
	#sticky-sidebar-demo{
        ...
        <div class="inner-page-banner-area" style="background-image: url('img/banner/5.jpg');">
            <div class="container">
                ...
                <?php
                $sq11=mysqli_query($conn,"select * from studdeg where id='".$_GET['deg']."' ");
...
<select class="form-control d-height" style="" id="changeyear" onchange="selStu();">
    
  <?php 
  $degree=$_GET['yr'];
  $sq1=mysqli_query($conn,"select * from studdeg where id='".$_GET['deg']."' ");
...
//$sqc=mysqli_query($conn,"select * from 	student where deg='".$_GET['deg']."' group by yr");
$sqc=mysqli_query($conn,"SELECT CAST(yr AS UNSIGNED),yr FROM student_math where deg='".$_GET['deg']."' group by yr order by yr desc");
...
<option value="<?php echo $roc['yr'];?>"><?php echo $roc['yr'];?></option>
    <?php } } ?>
			...
			<section class="panel" style="width:100%">
		            <header class="panel-heading"><?php echo $sq21['sname']; ?> - <?php echo $degree; ?></header> 
